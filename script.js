    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "היום הולדת של אביטל משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '6dac1ea0-9cb3-48c9-9c29-7552d3910433',
                    name: data.name || '',
                    email: data.email || '',
